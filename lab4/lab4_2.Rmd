...
# pulls out rows associated with "AL", using dplyr::filter
```{r}
filter(fish, lakeid == "AL")
 #notice its !!!2!!! equals signs
```
...
# can filer based on numerical and character data
```
...
# "%in%" allows you to find mulitple values within the same variable
```
...
# search for values within a given range
```
...
# search within plus or minus a tolerance
```
